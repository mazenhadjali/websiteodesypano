        ...
        <div className="container mx-auto my-2">
            <div id="default-carousel" className="relative" data-carousel="static">
                ...
                <button type="button"
                    ...
                    data-carousel-prev>
                    <span
                        className="inline-flex justify-center items-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-white/30  group-hover:bg-white/50  group-focus:ring-4 group-focus:ring-white  group-focus:outline-none">
                        <svg className="w-5 h-5 text-black sm:w-6 sm:h-6 " fill="none" stroke="currentColor" viewBox="0 0 24 24"
